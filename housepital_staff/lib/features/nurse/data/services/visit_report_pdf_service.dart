...
//
// Usage:
//   final service = VisitReportPdfService();
//
//   // Preview (shows system print dialog / PDF viewer)
//   await service.preview(booking, reportData, nurseName, duration);
//
//   // Share / download
//   await service.share(booking, reportData, nurseName, duration);
// ─────────────────────────────────────────────────────────────────────────────

class VisitReportPdfService {
  // ── Colours (matches AppColors palette) ──────────────────────────────────
  ...
  /// Build and open the system PDF preview / print dialog.
  Future<void> preview(
  ...
  /// Build and open the system share sheet (save / send).
  Future<void> share(
    NurseBooking booking,
    VisitReportData report,
    String nurseName,
  ...
  Future<pw.Document> _build(
    ...
    // Load Helvetica (built-in, no asset needed)
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (booking.address != null) ...[
                      ...
                      _metaSmall(booking.address!.fullAddress),
                    ],
                  ],
                ),
              ),
