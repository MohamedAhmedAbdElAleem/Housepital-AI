  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AdminCubit, AdminState>(
      listener: (context, state) {
        ...
        } else if (state is AdminAllUsersLoaded) {
          setState(() {
            _allUsers = List<Map<String, dynamic>>.from(state.users);
            _filterUsers();
            _isLoading = false;
          });
                        ...
                        if (status == 'pending') ...[
                              ...
                              Expanded(
                                child: OutlinedButton.icon(
                                  onPressed: () {
                                    ...
                                    context.read<AdminCubit>().updateUserStatus(
                                      user['id'] ?? user['_id'],
                                      'rejected',
                                    );
                                  },
                          ...
                          SizedBox(
                            ...
                            child: OutlinedButton.icon(
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<AdminCubit>().updateUserStatus(user['id'] ?? user['_id'], 'suspended');
                              },
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              onPressed: () {
                                Navigator.pop(context);
                                context.read<AdminCubit>().updateUserStatus(user['id'] ?? user['_id'], 'approved');
                              },
