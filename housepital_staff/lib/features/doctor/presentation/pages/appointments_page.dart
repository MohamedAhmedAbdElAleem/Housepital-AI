  ...
  Widget _buildPendingTab(List<dynamic> list) {
    if (list.isEmpty) {
      return _emptyState(
        ...
        subtitle: 'ستظهر هنا حجوزات المواعيد التي تحتاج موافقتك.',
      );
    }
  ...
  Widget _buildUpcomingTab(List<dynamic> list) {
    if (list.isEmpty) {
      return _emptyState(
        ...
        subtitle: 'المواعيد المؤكدة ستظهر هنا.',
      );
    }
    return ListView.builder(
      padding: const EdgeInsets.all(16),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Action: Start Visit or Complete Visit
            if (isInProgress)
              _actionButton(
                label: 'إنهاء الزيارة',
  ...
  Widget _buildPastTab(List<dynamic> list) {
    if (list.isEmpty) {
      return _emptyState(
        ...
        subtitle: 'المواعيد المكتملة والملغاة ستظهر هنا.',
      );
    }
    return ListView.builder(
      padding: const EdgeInsets.all(16),
