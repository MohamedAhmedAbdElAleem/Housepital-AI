...
class _Design {
  ...
  // Neutrals (light-mode defaults - still used as const where needed)
  ...
  // â”€â”€ Dynamic dark-mode aware helpers â”€â”€
  static Color bgColor(bool isDark) => isDark ? const Color(0xFF0D0C11) : background;
  static Color surfaceColor(bool isDark) => isDark ? const Color(0xFF16151A) : surface;
  static Color surfaceVariantColor(bool isDark) => isDark ? const Color(0xFF1E1C24) : surfaceVariant;
  static Color borderColor(bool isDark) => isDark ? const Color(0xFF2A2831) : border;
  static Color titleColor(bool isDark) => isDark ? const Color(0xFFF2F2F5) : textPrimary;
  static Color subtitleColor(bool isDark) => isDark ? const Color(0xFFA19EAB) : textSecondary;
  static Color mutedColor(bool isDark) => isDark ? const Color(0xFF5F5C68) : textMuted;
  static List<BoxShadow> shadowFor(bool isDark) => [
    BoxShadow(
...
class _AccountPageState extends State<AccountPage>
  ...
  bool _isDark = false; // Set in build()
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _Design.bgColor(_isDark),
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(color: _Design.subtitleColor(_isDark), fontSize: 15),
          ),
        ],
      ),
    );
  ...
  Widget _buildProfileCard() {
    return Container(
      decoration: BoxDecoration(
        color: _Design.surfaceColor(_isDark),
        borderRadius: BorderRadius.circular(24),
        border: _isDark ? Border.all(color: const Color(0xFF2A2831)) : null,
        boxShadow: _Design.shadowFor(_isDark),
      ),
      child: Column(
        children: [
          const SizedBox(height: 24),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: _Design.titleColor(_isDark),
            ),
          ),
          const SizedBox(height: 4),
          Text(
            _user?.email ?? '',
            style: TextStyle(fontSize: 14, color: _Design.subtitleColor(_isDark)),
          ),
          const SizedBox(height: 20),
        ...
        Container(
          ...
          child: ClipOval(
            child:
                _isUploadingImage
                    ? Container(
                      color: _Design.surfaceVariantColor(_isDark),
                      child: const Center(
                        child: CircularProgressIndicator(
                          color: _Design.primary,
                          strokeWidth: 2.5,
  ...
  Widget _buildVerificationBadge() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isVerified
            ? (_isDark ? const Color(0xFF0A2E1A) : _Design.successLight)
            : (_isDark ? const Color(0xFF2C1F00) : _Design.warningLight),
        ...
        children: [
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  fontSize: 13,
                  fontWeight: FontWeight.w600,
                  color: _Design.subtitleColor(_isDark),
                ),
              ),
          ...
          TextFormField(
            ...
            style: TextStyle(
              ...
              color: readOnly ? _Design.mutedColor(_isDark) : _Design.titleColor(_isDark),
            ),
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: TextStyle(
                color: _Design.mutedColor(_isDark),
                fontSize: 14,
              ),
              prefixIcon: Padding(
                ...
                child: Icon(
                  icon,
                  color: readOnly ? _Design.mutedColor(_isDark) : _Design.primary,
                  size: 22,
                ),
              ),
              prefixIconConstraints: const BoxConstraints(minWidth: 50),
              filled: true,
              fillColor: readOnly ? _Design.surfaceVariantColor(_isDark) : _Design.bgColor(_isDark),
              ...
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(14),
                borderSide: BorderSide(color: _Design.borderColor(_isDark).withOpacity(0.5)),
              ),
  ...
  Widget _buildDivider() {
    return Padding(
      ...
      child: Divider(height: 1, color: _Design.borderColor(_isDark).withOpacity(0.5)),
    );
  }
      ...
      children: [
        ...
        _buildEditableCard([
          ...
          _buildSecurityItem(
            ...
            title: 'Password',
            subtitle: 'ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¢',
  ...
  Widget _buildPasswordChangeForm() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _Design.borderColor(_isDark).withOpacity(0.5)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 12, color: _Design.subtitleColor(_isDark)),
          ),
          const SizedBox(height: 16),
  ...
  Widget _buildPasswordField({
    ...
    return TextField(
      controller: controller,
      obscureText: obscure,
      style: TextStyle(fontSize: 15, color: _Design.titleColor(_isDark)),
      decoration: InputDecoration(
        labelText: label,
        labelStyle: TextStyle(fontSize: 14, color: _Design.subtitleColor(_isDark)),
        ...
        filled: true,
        fillColor: _Design.surfaceColor(_isDark),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide.none,
        ),
                ...
                Text(
                  ...
                  style:
                      ...
                      TextStyle(
                        fontSize: 15,
                        fontWeight: FontWeight.w600,
                        color: valueColor ?? _Design.titleColor(_isDark),
                      ),
                ),
              ],
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: _isDark ? const Color(0xFF2A2831) : Colors.grey[300],
